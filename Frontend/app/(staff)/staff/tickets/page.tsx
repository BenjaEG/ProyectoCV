...
export default function StaffTicketsPage() {
  ...
  return (
    <>
      <DashboardHeader title="Gestión de Reclamos" description="Administra todos los reclamos vecinales" />
      <main className="flex-1 p-4 md:p-6">
        <Card className="bg-card border-border">
          <CardHeader>
            <CardTitle className="text-foreground">Todos los Reclamos</CardTitle>
          </CardHeader>
          <CardContent>
            {/* Filters */}
